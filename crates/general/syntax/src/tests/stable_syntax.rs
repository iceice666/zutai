...
#[test]
fn stable_record_row_tails_parse() {
...
#[test]
fn stable_explicit_row_spreads_parse() {
...
#[test]
fn stable_row_tail_overlapping_record_field_rejected() {
    assert!(parse("T :: type { host : Text; ...host; }\n1").has_errors());
}

#[test]
fn stable_record_row_tail_must_be_last_and_unique() {
...
#[test]
fn stable_union_payload_row_tail_rejected() {
    assert!(parse("T :: type { #ok: { value : Int; ...Rest; }; }\n1").has_errors());
}

#[test]
fn stable_union_row_tails_and_spreads_parse() {
...
#[test]
fn stable_value_select_preserves_field_order() {
...
#[test]
fn stable_value_select_operator_preserves_field_order() {
...
#[test]
fn stable_type_select_preserves_field_order() {
...
#[test]
fn stable_type_select_operator_preserves_field_order() {
...
#[test]
fn stable_effect_row_syntax_parses() {
...
#[test]
fn stable_effect_row_no_payload_and_signature_shapes() {
    let f = parse_str(
        r#"
...
#[test]
fn stable_effect_row_named_spread_before_tail_parses() {
    let f = parse_str(
        r#"
...
#[test]
fn stable_effect_row_qualified_spread_before_tail_parses() {
    let f = parse_str(
        r#"
...
#[test]
fn stable_effect_row_requires_operation_separators() {
    assert!(parse("parse :: Text -> Config ! { fail ParseError warn Diagnostic }\n  = text => text;\nparse").has_errors());
}

#[test]
fn stable_perform_handle_resume_parse() {
...
#[test]
fn stable_handle_with_clause_is_not_record_update() {
    let e = parse_expr_str(
        "handle check cfg with { warn = \\diagnostic => { perform log diagnostic; resume (); }; }",
    );
    match e {
...
#[test]
fn stable_config_names_parse_as_identifiers() {
...
#[test]
fn stable_reflection_builtins_parse_as_application() {
...
// ── Lexer coverage: stable keywords, @, scientific notation, unknown token ────────
