...
///
/// Phase 19 keeps DC/ANF/SSA pure by requiring pre-DC free-monad/CPS
/// elaboration. Until that lowering exists, residual effect nodes or non-empty
/// function effect rows must not be silently erased before compilation.
