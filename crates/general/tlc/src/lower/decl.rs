...
use zutai_thir::{
    RowTail, ThirClause, ThirConstraintMethod, ThirDeclId, ThirDeclKind, TypeId, TypeKind,
    TypeTupleItem,
};

use crate::ir::{
    BuiltinOp, Literal, Row, TlcAlt, TlcDecl, TlcDeclId, TlcExpr, TlcExprId, TlcPat, TlcPatItem,
    TlcTupleField, TlcTupleItem, TlcType,
};
