...
impl<'thir> Lowerer<'thir> {
    ...
    fn synthesize_data_empty_record(
        &mut self,
        data_ty: crate::ir::TlcTypeId,
        span: zutai_syntax::Span,
    ) -> Option<TlcExprId> {
