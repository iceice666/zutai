...
pub use ir::{
    EffectOp, EffectRow, RowTail, ThirClause, ThirConstraintMethod, ThirDecl, ThirDeclId,
    ThirDeclKind, ThirExpr, ThirExprId, ThirExprKind, ThirFile, ThirHandleClause, ThirLocalBinding,
    ThirPat, ThirPatId, ThirPatKind, ThirRecordField, ThirRecordPatField, ThirTupleItem,
    ThirTuplePatItem, ThirWitnessField, Type, TypeId, TypeKind, TypeRecordField, TypeTupleItem,
};
