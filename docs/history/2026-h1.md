# Implementation History: 2026 H1

Completed milestones through June 2026, newest first. These notes are
implementation provenance, not the current support contract. See the
...
_Completed 2026-06-27. Closes the open the former roadmap GC residual as a deliberate
...
(see `docs/project/roadmap.md`). Reference-interpreter support level — module imports remain
...
- **Deferred (open questions).** Stdlib-root resolution (a shared install location
  ...
  after import) stay out of scope — see the former roadmap.
...
- **Residual (deferred).** Multi-type use — one program using an imported generic
  ...
  `docs/project/roadmap.md`), because the boundary currently monomorphizes by first use. The
...
blocked by a backend gap (see `docs/project/roadmap.md` "Cross-module polymorphism")._
...
_Completed 2026-06-24. Time-boxed feasibility spike from `docs/project/roadmap.md`
...
representational blocker `docs/compiler/tlc.md` §9 named — DC types being finite
...
- **Forward-dated ARCHIVED stamps.** Nine `2026-06-25` stamps in
  `docs/project/status.md` (the "Current baseline" Last-updated note plus eight
...
_Completed 2026-06-24. Closes the Track 1 Phase D item in the former roadmap and the
...
_Completed 2026-06-24. Closes the Track 1 Phase C item in the former roadmap and the
...
_Completed 2026-06-24. Closes the Track 2 Phase 33 item in the former roadmap and the
...
v1 native-backend constraints/witnesses item in the former roadmap. Imported parametric
...
constraints/witnesses item in the former roadmap; also fixes a conditional-witness dispatch segfault._
...
- Effect: deep tail recursion that previously overflowed the native stack
  ...
  `docs/compiler/runtime-abi.md` and the former roadmap).
...
- Documented in `docs/compiler/runtime-abi.md` (D-0008, "Memory model: thread-local
...
- `docs/compiler/anf.md` and `crates/general/anf/` exist.
