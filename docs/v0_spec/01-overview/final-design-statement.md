...
`.zt` is pure lazy typed computation over data. It provides three declaration forms, one namespace, functions, imports, records, lists, optionals, union types, tagged variants, pattern matching, and parametric generics.
