...
`.zt` is pure lazy typed computation over data. It provides three declaration forms, one namespace, functions, imports, records, tuples, lists, optionals, union types, tuple variants, pattern matching, and parametric generics.
